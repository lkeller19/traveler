...
import datetime
# code adapted from https://stackoverflow.com/questions/1551382/user-friendly-time-format-in-python
...
def date(timestamp=False):
    ...
    years = time.year
    day = time.day
    month = datetime.strftime(time, '%b')
    return str(month) + ' ' + str(day) + ', ' + str(years)